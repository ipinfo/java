...
public class IPinfoCoreTest {

    @Test
    public void testAccessToken() {
        String token = "test_token";
        IPinfoCore client = new IPinfoCore.Builder()
            .setToken(token)
            .build();
    ...
    public void testGoogleDNS() {
        ...
        try {
            IPResponseCore response = client.lookupIP("8.8.8.8");
            assertAll(
                "8.8.8.8",
    ...
    public void testBogon() {
        ...
        try {
            IPResponseCore response = client.lookupIP("127.0.0.1");
            assertAll(
                "127.0.0.1",
    ...
    public void testCloudFlareDNS() {
        ...
        try {
            IPResponseCore response = client.lookupIP("1.1.1.1");
            assertAll(
                "1.1.1.1",
